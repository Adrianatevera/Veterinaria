    ...
    <div class="container">
        <nav class="menu-column rounded-r-xl flex flex-col justify-between">
            <ul>
                ...
                <li class="link-parent">
                    <a class="flex gap-3 py-4" href="SUBMENUS/Administradores.php">
                ...
                <li class="link-parent">
                    <a class="flex gap-3 py-4" href="SUBMENUS/Medicos.php">
                ...
                <li class="link-parent">
                    <a class="flex gap-3 py-4" href="SUBMENUs/reportes/Informes.php">
                ...
                <li class="link-parent">
                    <a class="flex gap-3 py-4" href="SUBMENUs/reportes_receta/Informes_receta.php">
